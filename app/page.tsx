...
const TREE_LEVELUP_MESSAGES: Record<number, string> = {
  2: "ふたりで続けた気持ちが、そっと芽を出したよ",
  3: "ふたりで続けた気持ちが、少しずつ葉を広げているよ",
  4: "ふたりで続けた気持ちが、木のかたちになってきたよ",
  5: "ふたりで続けた気持ちが、しっかり根づいてきたよ",
  6: "ふたりで続けた気持ちに、やさしい花が咲いたよ",
  7: "ふたりで続けた気持ちが、あたたかな実りになったよ",
};
